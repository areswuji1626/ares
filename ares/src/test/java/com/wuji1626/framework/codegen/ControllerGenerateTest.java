...
public class ControllerGenerateTest {
	...
	@Test
	public void MySQLControllerGenerateTest(){
		...
		Result<String> controllerRes = service.generateController(config);
		Assert.assertEquals(CommonConstant.SUCCESS_ST, controllerRes.getStatus());
