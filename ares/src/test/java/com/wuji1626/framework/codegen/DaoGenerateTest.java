...
public class DaoGenerateTest {
	...
	@Test
	public void MySQLDaoGenerateTest(){
		...
		Result<String> daoRes = service.generateDao(config);
		Assert.assertEquals(CommonConstant.SUCCESS_ST, daoRes.getStatus());
	}
}
