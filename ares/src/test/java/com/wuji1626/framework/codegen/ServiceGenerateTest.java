...
public class ServiceGenerateTest {
	...
	@Test
	public void MySQLServiceGenerateTest(){
		...
		Result<String> serviceRes = service.generateService(config);
		Assert.assertEquals(CommonConstant.SUCCESS_ST, serviceRes.getStatus());
	}
}
